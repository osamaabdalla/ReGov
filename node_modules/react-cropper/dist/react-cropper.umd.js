...
var applyDefaultOptions = function (cropper, options) {
    ...
    var _a = options.enable, enable = _a === void 0 ? true : _a, _b = options.scaleX, scaleX = _b === void 0 ? 1 : _b, _c = options.scaleY, scaleY = _c === void 0 ? 1 : _c, _d = options.zoomTo, zoomTo = _d === void 0 ? 1 : _d, _e = options.rotateTo, rotateTo = _e === void 0 ? 0 : _e;
...
var ReactCropper = React__default['default'].forwardRef(function (_a, ref) {
    ...
    React.useEffect(function () {
        if (cropperRef !== null && cropperRef.current !== null && typeof cropperRef !== 'undefined' && cropperRef) {
            var cropper_1 = new Cropper__default['default'](cropperRef.current, __assign(__assign({ dragMode: dragMode }, rest), { ready: function (e) {
                    if (e.target !== null) {
                        var target = e.target;
    ...
    return (React__default['default'].createElement("div", { style: style, className: className },
        React__default['default'].createElement("img", { crossOrigin: crossOrigin, src: src, alt: alt, style: { opacity: 0, maxWidth: '100%' }, ref: ref })));
});

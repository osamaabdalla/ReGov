...
var ReactCropper = React.forwardRef(function (_a, ref) {
    ...
    useEffect(function () {
        if (cropperRef !== null && cropperRef.current !== null && typeof cropperRef !== 'undefined' && cropperRef) {
            var cropper_1 = new Cropper(cropperRef.current, __assign(__assign({ dragMode: dragMode }, rest), { ready: function (e) {
                    if (e.target !== null) {
                        var target = e.target;
    ...
    return (React.createElement("div", { style: style, className: className },
        React.createElement("img", { crossOrigin: crossOrigin, src: src, alt: alt, style: { opacity: 0, maxWidth: '100%' }, ref: ref })));
});
